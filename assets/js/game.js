...
var fight = function (enemy) {
    ...
    // *Keep track of who will go first. (Variable is initialized with a value of true to start)
    ...
    while (playerInfo.health > 0 && enemy.health > 0) {
        // ! Check whose turn it is. IF TRUE, then prompt the player to fight or skip.
        if (isPlayerTurn) {
            ...
            // ! ELSE, player gets attacked first by robot enemy
        } else {
